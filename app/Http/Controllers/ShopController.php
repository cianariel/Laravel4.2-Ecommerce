...
class ShopController extends ApiController
{
    ...
    public function index($grandParent = false, $parent = false, $child = false)
    {
        ...
        if(!$grandParent){ // shop landing page
            ...
            switch($grandParent){
                case "smart-home":
                    $categoryModel->background_image = env('ASSETS_CDN') . "/images/shop-category/smarthome.jpg";
                break;
                case "travel":
                    $categoryModel->background_image =  env('ASSETS_CDN') ."/images/shop-category/travel.jpg";
                break;
                case "wearables":
                    $categoryModel->background_image =  env('ASSETS_CDN') ."/images/shop-category/wearables.jpg";
                break;
                case "home-decor":
                    $categoryModel->background_image =  env('ASSETS_CDN') ."/images/shop-category/homedecor.jpg";
                break;
            }
