...
<table id="Table_01" style="margin:0 auto;" width="584" height="3708" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr style="font-size: 0px">
        <td colspan="2" rowspan="2">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_02.gif" width="131" height="112" alt=""></td>
        <td colspan="4">
            <a href="http://ideaing.com/">
                <img src="http://ideaing.com/assets/images/email/welcome/logo.gif" width="223" height="82" border="0" alt="Ideaing"></a></td>
        <td colspan="6" rowspan="2">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_04.gif" width="230" height="112" alt=""></td>
    </tr>
    <tr style="font-size: 0px">
        <td colspan="4">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_05.gif" width="223" height="30" alt=""></td>
    </tr>
    <tr style="font-size: 0px">
        <td colspan="11">
            <a href="http://ideaing.com/">
                <img src="http://ideaing.com/assets/images/email/welcome/main-manner.gif" width="558" height="299" border="0" alt="Ideaing banner"></a></td>
        <td rowspan="6">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_07.gif" width="26" height="573" alt=""></td>
    </tr>
    <tr style="font-size: 0px">
        <td colspan="11">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_08.gif" width="558" height="21" alt=""></td>
    </tr>
    <tr style="font-size: 0px">
        <td colspan="3" rowspan="2">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_09.gif" width="147" height="113" alt=""></td>
        <td colspan="2">
            <a href="http://ideaing.com/signup">
                <img src="http://ideaing.com/assets/images/email/welcome/get-started.gif" width="187" height="64" border="0" alt="start with ideaing"></a></td>
        <td colspan="6" rowspan="2">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_11.gif" width="224" height="113" alt=""></td>
    </tr>
    <tr style="font-size: 0px">
        <td colspan="2">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_12.gif" width="187" height="49" alt=""></td>
    </tr>
    <tr style="font-size: 0px">
        <td rowspan="2">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_13.gif" width="39" height="140" alt=""></td>
        <td colspan="8">
            <a href="http://ideaing.com/room/kitchen">
                <img src="http://ideaing.com/assets/images/email/welcome/link-to-room.gif" width="405" height="109" border="0" alt="room ideaing"></a></td>
        <td colspan="2" rowspan="2">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_15.gif" width="114" height="140" alt=""></td>
    </tr>
    <tr style="font-size: 0px">
        <td colspan="8">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_16.gif" width="405" height="31" alt=""></td>
    </tr>
    <tr style="font-size: 0px">
        <td colspan="12">
            <a href="http://ideaing.com/room/office">
                <img src="http://ideaing.com/assets/images/email/welcome/product.gif" width="584" height="377" border="0" alt="office item"></a></td>
    </tr>
    <tr style="font-size: 0px">
        <td colspan="10">
            <a href="http://ideaing.com/shop">
                <img src="http://ideaing.com/assets/images/email/welcome/start-shopping.gif" width="478" height="142" border="0" alt="shopping "></a></td>
        <td colspan="2" rowspan="2">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_19.gif" width="106" height="193" alt=""></td>
    </tr>
    <tr style="font-size: 0px">
        <td colspan="10">
            <a href="http://ideaing.com/">
                <img src="http://ideaing.com/assets/images/email/welcome/profile.gif" width="478" height="51" border="0" alt="profile "></a></td>
    </tr>
    <tr style="font-size: 0px">
        <td colspan="8">
            <a href="http://ideaing.com/">
                <img src="http://ideaing.com/assets/images/email/welcome/profile-22.gif" width="392" height="57" border="0" alt="profile "></a></td>
        <td colspan="4" rowspan="2">
            <a href="http://ideaing.com">
                <img src="http://ideaing.com/assets/images/email/welcome/comment.gif" width="192" height="176" border="0" alt="comment"></a></td>
    </tr>
    <tr  style="font-size: 0px">
        <td colspan="8">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_23.gif" width="392" height="119" alt=""></td>
    </tr>
    <tr  style="font-size: 0px">
        <td colspan="10">
            <a href="http://ideaing.com/">
    ...
    <tr  style="font-size: 0px">
        <td colspan="10">
            <a href="http://ideaing.com/">
                <img src="http://ideaing.com/assets/images/email/welcome/product-27.gif" width="478" height="418" border="0" alt=""></a></td>
    </tr>
    <tr  style="font-size: 0px">
        <td colspan="10">
            <a href="http://ideaing.com/">
                <img src="http://ideaing.com/assets/images/email/welcome/product-28.gif" width="478" height="522" border="0" alt="product ideaing"></a></td>
    </tr>
    <tr  style="font-size: 0px">
        <td colspan="10">
            <a href="http://ideaing.com/">
                <img src="http://ideaing.com/assets/images/email/welcome/product-29.gif" width="478" height="501" border="0" alt="product"></a></td>
    </tr>
    <tr  style="font-size: 0px">
        <td colspan="10">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_29.gif" width="478" height="46" alt=""></td>
    </tr>
    <tr style="font-size: 0px">
        <td colspan="3" rowspan="2">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_30.gif" width="147" height="111" alt=""></td>
        <td colspan="2">
            <a href="http://ideaing.com/">
                <img src="http://ideaing.com/assets/images/email/welcome/discussion.gif" width="187" height="65" border="0" alt="discussion"></a></td>
        <td colspan="5" rowspan="2">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_32.gif" width="144" height="111" alt=""></td>
    </tr>
    <tr style="font-size: 0px">
        <td colspan="2">
            <img src="http://ideaing.com/assets/images/email/welcome/Newsletter-Inp_33.gif" width="187" height="46" alt=""></td>
    </tr>
    <tr style="font-size: 0px">
        <td colspan="10">
    ...
    <tr style="font-size: 0px">
        ...
        <td>
            <img src="http://ideaing.com/assets/images/email/welcome/spacer.gif" width="92" height="1" alt=""></td>
        <td>
            <img src="http://ideaing.com/assets/images/email/welcome/spacer.gif" width="16" height="1" alt=""></td>
        <td>
            <img src="http://ideaing.com/assets/images/email/welcome/spacer.gif" width="133" height="1" alt=""></td>
        <td>
            <img src="http://ideaing.com/assets/images/email/welcome/spacer.gif" width="54" height="1" alt=""></td>
        <td>
            <img src="http://ideaing.com/assets/images/email/welcome/spacer.gif" width="20" height="1" alt=""></td>
        <td>
            <img src="http://ideaing.com/assets/images/email/welcome/spacer.gif" width="8" height="1" alt=""></td>
        <td>
            <img src="http://ideaing.com/assets/images/email/welcome/spacer.gif" width="30" height="1" alt=""></td>
        <td>
            <img src="http://ideaing.com/assets/images/email/welcome/spacer.gif" width="52" height="1" alt=""></td>
        <td>
            <img src="http://ideaing.com/assets/images/email/welcome/spacer.gif" width="34" height="1" alt=""></td>
        <td>
            <img src="http://ideaing.com/assets/images/email/welcome/spacer.gif" width="80" height="1" alt=""></td>
        <td>
            <img src="http://ideaing.com/assets/images/email/welcome/spacer.gif" width="26" height="1" alt=""></td>
    </tr>
</table>
