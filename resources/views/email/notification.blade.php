                                       ...
                                       <tbody>
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;" st-content="fulltext-content">
                                                <p align="left">
                                                    <span style="font-size: 14pt;" class="im"><br><span style="font-size: 14pt;">You have {{$content}} new notification on Ideaing.</span><span
                                                                style="font-size: 14pt;">Click<a
                                                                    style="color:rgb(250,0,51);text-decoration:none"
                                                                    href="{{ url('/user/notification')}}"> Show Notifications</a> to view latest events.</span> </span>
                                                </p>
                                             </td>
                                          </tr>
                                          <!-- End of content -->
                                                      ...
                                                      <tr>
                                                         <td width="290" height="160" align="center" class="devicewidth">
                                                            <div class="imgpop" style="margin-top: 20px;border-radius:6px;background-color:rgb(250,0,51);min-height:25px;width:150px;text-align: center; line-height:50px;">
                                                                <a style=" color:white;font-weight: bold;" href="{{ url('/user/notification')}}"> Show Notifications</a>
                                                            </div>
                                                         </td>
                                                      </tr>
                                                   </tbody>
