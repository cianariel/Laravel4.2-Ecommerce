                    ...
                    <form role="form" name="myForm" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
                        <div class="portlet">
                            <div class="portlet-title">
                                ...
                                <div class="caption">
                                    <i class="fa fa-shopping-cart"></i>Add / Update Product </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active in" id="home">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Free Shipping Available : </label>
                                                    <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Similar Products (Auto Complete)</label>
                                                    <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    <label  class="col-md-2 control-label">Product Availability</label>
                                                    <div class="col-md-10">
