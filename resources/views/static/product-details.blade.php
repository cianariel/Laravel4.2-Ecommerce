    ...
    <nav id="hero-nav" class="col-sm-12">
        <div class="container full-620  fixed-sm">
            <ul class="category-nav">
                ...
                <li><a href="" class="ideas-link">Features</a></li>
                <li><a href="" class="products-link">Specs</a></li>
                <li><a href="" class="products-link">Comparisons</a></li>
                <li><a href="" class="products-link">Reviews</a></li>
            </ul>
        </div>
    </nav>
