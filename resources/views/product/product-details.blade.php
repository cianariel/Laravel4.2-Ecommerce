    ...
    <div id="productApp" ng-app="productApp" data-ng-controller="productController" ng-cloak>
        <header class="story-header hidden-620 hidden-soft">
            ...
            <ul class="share-buttons short hidden-xs col-lg-6 col-sm-8 pull-right">
                ...
                <li><a class="twi" href="#"
                       onclick="javascript: (function() {
                               window.open('https://twitter.com/share?url=' + window.location.host + window.location.pathname + '&counturl=' + thisUrl + '&text=@Ideaing', 'fbwindow', 'width=600, height=360, left=250, top=150, toolbar=0, location=0, menubar=0, scrollbars=0');})();">
