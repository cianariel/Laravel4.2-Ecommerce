                                ...
                                @else
                                   <form id="giveaway-two" ng-if="!responseMessage.success">
	                                   <div>
		                                ...
		                                <button style="margin-top: 30px;" ng-click="enterGiveaway('giveaway-two',  false)" class="btn btn-success col-xs-12"  href="#">Enter Giveaway</button>
	                               </form>
                       ...
                       @else
                           ...
                           <div  id="publicApp" ng-app="publicApp" ng-controller="publicController" class="col-lg-6 col-xs-12 qiuck-signup pull-right giveaway-login" ng-cloak>
                             		...
                             		<form id="giveaway-two" ng-if="!responseMessage.success">
	                                   ...
	                                   <button ng-click="enterGiveaway('giveaway-two', true)" class="btn btn-success col-xs-12"  href="#">Enter Giveaway</button>
		                            </form>
