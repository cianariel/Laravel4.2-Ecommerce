                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-12">
                            <input class="form-control" ng-model="data.FullName"
                                   ng-init="data.FullName = '<?php echo $userData['name'] ?>'" placeholder="Full name">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control personal-link" ng-model="data.Permalink"
                                       ng-init="data.Permalink = '<?php echo $userData['userProfile']['permalink']  ?>'"
                                       placeholder="">
                            </div>
                        </div>
                    </div>
        ...
        <div id="publicApp">
            <div class="content-container">
                <div class="content-holder">
                    <div>
                        <h4>Subscribe me to the world's finest design ideas community</h4></div>
                    <br>
                    <div>
            ...
            <div class="img-holder"><img src="/assets/images/emailpopupimg.png"
