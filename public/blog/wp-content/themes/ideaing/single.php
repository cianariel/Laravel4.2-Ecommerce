...
<?php if (have_posts()): while (have_posts()) : the_post(); ?>
        <header class="story-header hidden-620 hidden-soft" >
            ...
            <h1>
                {{the_title()}}
                <a class="like-counter" href="#"><span>Liked by</span>189</a>
            </h1>

            <ul class="social-rounds hidden-sm hidden-xs ">
                <li class="all-shares"><b>120K </b>all shares</li>
                <li><a class="fb" href="#"></a> <span class="dark-blue">1.5k</span></li>
                <li><a class="twi" href="#"></a> <span class="blue">330</span></li>
