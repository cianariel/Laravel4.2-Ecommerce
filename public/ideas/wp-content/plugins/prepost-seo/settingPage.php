...
die('Direct Access not permitted...'); 
	...
	/*$url = 'http://cdn3.wpbeginner.com/wp-content/uploads/2011/10/grabandsave.gif';
	...
	*/
	...
	$data = file_get_contents(PPS_ACTION_SITE.'frontend/getAccountSettings/'.$accKey);
...
<table  class="pps-setting-table">
    ...
    <tr>
        ...
        <a href="<?= admin_url(); ?>admin.php?page=prepost-seo"> &laquo;Back to Setting Page</a>
        </td>
    ...
    <tr>
        <td><a href="<?= admin_url(); ?>admin.php?page=prepost-seo"> &laquo;Back to Setting Page</a></td>
        <td align="center">
...
<table  class="pps-setting-table">
	<tr>
    	<td colspan="2" style="background:#EBEBEB; color:#000; font-size:16px; text-align:center;">
            ...
            <a href="<?php echo PPS_ACTION_SITE; ?>login" target="_blank" style="float:right;" class="button-secondary button-small">Create account</a>
        </td>
    </tr>
    ...
    <tr>
        <td colspan="2" style="color:#000;">
            To activate this plugin please <a href="<?php echo PPS_ACTION_SITE; ?>login" target="_blank">create an account</a> at prepostseo.com<br>
            ...
            <br>
            <a href="<?php echo PPS_ACTION_SITE; ?>login" target="_blank">click here to get API KEY</a>
        </td>
    </tr>
    <?php else: ?>
    <tr>
